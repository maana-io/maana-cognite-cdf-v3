...
export const environment: Environment = {
  ...
  // Cognite
  cogniteAppId: process.env.COGNITE_APP_ID || "Maana Q",
  cogniteProject: process.env.COGNITE_PROJECT || "publicdata",
  cogniteCredentials: process.env.COGNITE_CREDENTIALS || "",
};
